...
import { Mail, MapPin, Clock, Instagram, MessageCircle, ChevronDown } from "lucide-react";
            ...
            {status === "sent" ? (
              ...
              >
                ...
                <p className="mt-4 text-[14px] leading-[1.85] text-ethra-charcoal max-w-sm">
                  Hemos recibido tu mensaje. Nos pondremos en contacto contigo en las próximas 24–48 horas hábiles.
                </p>
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-7">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full border border-ethra-stone/25 bg-transparent px-4 py-3 text-[14px] text-ethra-black placeholder:text-ethra-stone/40 transition-colors focus:border-ethra-black focus:outline-none"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={form.asunto}
                      onChange={handleChange}
                      className="w-full appearance-none border border-ethra-stone/25 bg-ethra-bone px-4 py-3 pr-10 text-[14px] text-ethra-black transition-colors focus:border-ethra-black focus:outline-none cursor-pointer"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none border border-ethra-stone/25 bg-transparent px-4 py-3 text-[14px] text-ethra-black placeholder:text-ethra-stone/40 transition-colors focus:border-ethra-black focus:outline-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <button
                    ...
                    className="border border-ethra-black px-10 py-3.5 font-display text-[10px] tracking-luxury uppercase text-ethra-black transition-colors hover:bg-ethra-black hover:text-ethra-bone disabled:opacity-50 disabled:cursor-not-allowed"
                  >
